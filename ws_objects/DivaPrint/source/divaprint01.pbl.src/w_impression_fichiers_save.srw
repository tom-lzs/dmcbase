$PBExportHeader$w_impression_fichiers_save.srw
forward
global type w_impression_fichiers_save from w_a
end type
type sle_facture_from from u_slea within w_impression_fichiers_save
end type
type st_3 from statictext within w_impression_fichiers_save
end type
type st_4 from statictext within w_impression_fichiers_save
end type
type sle_pays from u_slea within w_impression_fichiers_save
end type
type st_1 from statictext within w_impression_fichiers_save
end type
type cbx_select from u_cbxa within w_impression_fichiers_save
end type
type sle_facture_to from u_slea within w_impression_fichiers_save
end type
type st_date_from from statictext within w_impression_fichiers_save
end type
type r_param from rectangle within w_impression_fichiers_save
end type
type st_facture from statictext within w_impression_fichiers_save
end type
type em_date_to from u_ema within w_impression_fichiers_save
end type
type cbx_facture from u_cbxa within w_impression_fichiers_save
end type
type dw_document from u_dw_udim within w_impression_fichiers_save
end type
type em_date_from from u_ema within w_impression_fichiers_save
end type
type st_date_to from statictext within w_impression_fichiers_save
end type
type sle_code_client from u_slea within w_impression_fichiers_save
end type
type st_2 from statictext within w_impression_fichiers_save
end type
type sle_lines from u_slea within w_impression_fichiers_save
end type
type cb_ok from u_cba within w_impression_fichiers_save
end type
type rb_cc from u_rba within w_impression_fichiers_save
end type
type gb_doc from groupbox within w_impression_fichiers_save
end type
type rb_fa from u_rba within w_impression_fichiers_save
end type
type ln_1 from line within w_impression_fichiers_save
end type
end forward
...
global w_impression_fichiers_save w_impression_fichiers_save
...
on w_impression_fichiers_save.create
int iCurrent
call super::create
...
on w_impression_fichiers_save.destroy
call super::destroy
