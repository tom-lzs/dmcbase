$PBExportHeader$w_message_9091.srw
$PBExportComments$Permet la gestion du message associé à une commande.
forward
global type w_message_9091 from w_message_cde_response
end type
end forward
...
global w_message_9091 w_message_9091

on w_message_9091.create
call super::create
end on

on w_message_9091.destroy
call super::destroy
end on
...
event ue_init;call super::ue_init;this.title = g_nv_traduction.get_traduction('TRAITEMENT_CDE')
end event
...
type uo_statusbar from w_message_cde_response`uo_statusbar within w_message_9091
integer x = 2478
integer y = 308
end type

type dw_1 from w_message_cde_response`dw_1 within w_message_9091
...
integer height = 672
integer taborder = 0
string dataobject = "d_texte_come9091"
borderstyle borderstyle = stylelowered!
end type

type dw_mas from w_message_cde_response`dw_mas within w_message_9091
string tag = "A_TRADUIRE"
integer height = 512
end type

type pb_echap from w_message_cde_response`pb_echap within w_message_9091
integer y = 1420
string picturename = "C:\appscir\Erfvmr_diva\Image\pbechap.bmp"
end type

type pb_ok from w_message_cde_response`pb_ok within w_message_9091
integer y = 1428
string picturename = "C:\appscir\Erfvmr_diva\Image\pbok.bmp"
end type

type pb_suppression from w_message_cde_response`pb_suppression within w_message_9091
...
type pb_impression from w_message_cde_response`pb_impression within w_message_9091
integer y = 1424
integer taborder = 30
