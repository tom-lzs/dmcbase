$PBExportHeader$w_select_client.srw
$PBExportComments$Permet la recherche d'un client
forward
global type w_select_client from w_a
end type
type cb_2 from u_cba within w_select_client
end type
type cb_1 from u_cba within w_select_client
end type
type sle_1 from u_slea within w_select_client
end type
type st_1 from statictext within w_select_client
end type
type gb_1 from groupbox within w_select_client
end type
end forward
...
global w_select_client w_select_client
