$PBExportHeader$w_message_9088.srw
$PBExportComments$Permet la gestion du message associé à une commande.
forward
global type w_message_9088 from w_message_cde_response
end type
end forward
...
global w_message_9088 w_message_9088

on w_message_9088.create
call super::create
end on

on w_message_9088.destroy
call super::destroy
end on
...
event ue_init;call super::ue_init;this.title = g_nv_traduction.get_traduction('MARQUAGE_CAISSE')
end event
...
type uo_statusbar from w_message_cde_response`uo_statusbar within w_message_9088
integer x = 2478
integer y = 308
end type

type dw_1 from w_message_cde_response`dw_1 within w_message_9088
string tag = "A_TRADUIRE"
integer x = 402
integer y = 800
integer width = 2085
integer height = 352
string dataobject = "d_texte_come9088"
...
type dw_mas from w_message_cde_response`dw_mas within w_message_9088
string tag = "A_TRADUIRE"
integer height = 512
end type

type pb_echap from w_message_cde_response`pb_echap within w_message_9088
integer y = 1356
string picturename = "C:\appscir\Erfvmr_diva\Image\pbechap.bmp"
end type

type pb_ok from w_message_cde_response`pb_ok within w_message_9088
integer y = 1364
string picturename = "C:\appscir\Erfvmr_diva\Image\pbok.bmp"
end type

type pb_suppression from w_message_cde_response`pb_suppression within w_message_9088
boolean visible = false
integer y = 1360
string picturename = "C:\appscir\Erfvmr_diva\Image\PB_SUPPR.BMP"
end type

type pb_impression from w_message_cde_response`pb_impression within w_message_9088
integer y = 1360
