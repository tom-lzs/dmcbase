$PBExportHeader$nv_trans_dbi_syb_pt.sru
$PBExportComments$Ancêtre des objets d'interface de transaction de base de données pour Sybase
forward
global type nv_trans_dbi_syb_pt from nv_trans_dbi
end type
end forward

global type nv_trans_dbi_syb_pt from nv_trans_dbi
end type
global nv_trans_dbi_syb_pt nv_trans_dbi_syb_pt
...
// Retrieve current date/time from Sybase.
...
on nv_trans_dbi_syb_pt.create
TriggerEvent( this, "constructor" )
end on

on nv_trans_dbi_syb_pt.destroy
