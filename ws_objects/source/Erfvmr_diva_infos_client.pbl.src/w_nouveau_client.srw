...
//----------------------------------------
// creation d'une ligne dans la tabcle client ext
//---------------------------------------------------
Datastore l_ds_client_ext
l_ds_client_ext = CREATE Datastore
l_ds_client_ext.Dataobject = "d_client_ext"
l_ds_client_ext.SetTransObject (sqlca) 

l_ds_client_ext.retrieve(dw_1.GetItemString (1, DBNAME_CLIENT_CODE))
l_ds_client_ext.insertRow(0)
l_ds_client_ext.SetItem(1,DBNAME_DATE_CREATION, 	i_tr_sql.fnv_get_datetime ())
l_ds_client_ext.SetItem(1,DBNAME_CODE_MAJ, 	CODE_CREATION)	 
l_ds_client_ext.SetItem(1,DBNAME_CLIENT_CODE, 	dw_1.GetItemString (1, DBNAME_CLIENT_CODE))	 	
l_ds_client_ext.SetItem(1,"tiersref",dw_1.GetItemString (1, DBNAME_CLIENT_CODE))
l_ds_client_ext.Update ()
