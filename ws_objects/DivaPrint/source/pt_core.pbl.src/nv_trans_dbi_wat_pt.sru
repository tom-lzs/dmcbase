$PBExportHeader$nv_trans_dbi_wat_pt.sru
$PBExportComments$Ancêtre des objets d'interface de transaction de base de données pour Watcom
forward
global type nv_trans_dbi_wat_pt from nv_trans_dbi
end type
end forward

global type nv_trans_dbi_wat_pt from nv_trans_dbi
end type
global nv_trans_dbi_wat_pt nv_trans_dbi_wat_pt
...
// Retrieve current date/time from Watcom.
...
on nv_trans_dbi_wat_pt.create
TriggerEvent( this, "constructor" )
end on

on nv_trans_dbi_wat_pt.destroy
