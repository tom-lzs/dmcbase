$PBExportHeader$w_message_9087.srw
$PBExportComments$Permet la gestion du message associé à une commande.
forward
global type w_message_9087 from w_message_cde_response
end type
type dw_2 from u_dwa within w_message_9087
end type
type ln_1 from line within w_message_9087
end type
end forward
...
global w_message_9087 w_message_9087

on w_message_9087.create
int iCurrent
call super::create
...
this.title = g_nv_traduction.get_traduction('TRANSPORTEUR')
end event
...
type uo_statusbar from w_message_cde_response`uo_statusbar within w_message_9087
integer x = 2478
integer y = 308
end type

type dw_1 from w_message_cde_response`dw_1 within w_message_9087
string tag = "A_TRADUIRE"
integer x = 439
integer y = 1280
integer width = 2304
integer height = 224
string dataobject = "d_texte_come9087_complement"
boolean vscrollbar = false
borderstyle borderstyle = stylelowered!
end type

event dw_1::we_dwnprocessenter;// overwtire
end event

type dw_mas from w_message_cde_response`dw_mas within w_message_9087
string tag = "A_TRADUIRE"
integer height = 512
end type

type pb_echap from w_message_cde_response`pb_echap within w_message_9087
integer y = 1804
string picturename = "C:\appscir\Erfvmr_diva\Image\pbechap.bmp"
end type

type pb_ok from w_message_cde_response`pb_ok within w_message_9087
integer y = 1812
string picturename = "C:\appscir\Erfvmr_diva\Image\pbok.bmp"
end type

type pb_suppression from w_message_cde_response`pb_suppression within w_message_9087
integer y = 1808
string picturename = "C:\appscir\Erfvmr_diva\Image\PB_SUPPR.BMP"
end type

type pb_impression from w_message_cde_response`pb_impression within w_message_9087
integer y = 1808
...
string dataobject = "d_texte_come9087"
