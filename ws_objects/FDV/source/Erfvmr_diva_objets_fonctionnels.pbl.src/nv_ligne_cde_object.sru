...
public function boolean fu_controle_et_maj_ligne_cde (long al_row, ref datawindow adw_ligne_cde, boolean ab_mode_saisie_dimension, boolean ab_mode_validation_complete);/* <DESC>
	...
	- 2021/12 Controle si existence de relicat sur cette référence pour le client.
	  Si oui, affichage de la qté en relicat
	- 2021-12 Affichage du stock disponible
...
//========================
 //    Affichage es relicats
//========================
ds_datastore = create nv_datastore
ds_datastore.dataobject = "d_ctrl_stock"  
ds_datastore.settrans( SQLCA)
if ds_datastore.retrieve(s_article, s_dimension) > 0 then
	adw_ligne_cde.SetItem(ll_row_a_controler,"stkdispo" ,ds_datastore.GetItemDecimal(1,"stkaedis")	)
end if

//========================
//     Affichage es relicats
//========================
ds_datastore.dataobject = "d_ctrl_relicats"  
ds_datastore.settrans( SQLCA)
if ds_datastore.retrieve(i_nv_commande.fu_get_client_donneur_ordre(), s_article, s_dimension) > 0 then
	adw_ligne_cde.SetItem(ll_row_a_controler,"relicat" ,ds_datastore.GetItemDecimal(1,"relicat")	)
end if
